...
Role :  CSRF medium level on DVWA
        ...
        Only for DVWA Version 1.0.7 (Release date: 08/09/10) 
...
# To use Burp proxy, you can add proxies=proxies in attr of requests.get or post
# e.g : s.get(url, proxies=proxies) you'll obtain a history in burpsuite to know exactly what the program has sent
